...
<head>
    ...
    <link rel="stylesheet" href="/adgloriam/style.css">
</head>
<body>
            ...
            <li class="nav-item">
                <div class="dropdown">
                    ...
                    <div class="dropdown-content build">
                        <div class="weapons">
                            <a href="./swordshield<?php echo linklang;?>" id='ss'><?php echo ss; ?></a>
                            <a href="./hatchet<?php echo linklang;?>" id='hatch'><?php echo hatch; ?></a>
                            <a href="./rapier<?php echo linklang;?>" id='rap'><?php echo rap; ?></a>
                            <a href="./lance<?php echo linklang;?>" id='lan'><?php echo lan; ?></a>
                            <a href="./hammer<?php echo linklang;?>" id='hamm'><?php echo hamm; ?></a>
                            <a href="./greataxe<?php echo linklang;?>" id='grtx'><?php echo grtx; ?></a>
                            <a href="./bow<?php echo linklang;?>" id='bow'><?php echo bow; ?></a>
                            <a href="./musket<?php echo linklang;?>" id='musk'><?php echo musk; ?></a>
                            <a href="./firestaff<?php echo linklang;?>" id='fires'><?php echo fires; ?></a>
                            <a href="./icegauntlet<?php echo linklang;?>" id='iceg'><?php echo iceg; ?></a>
                            <a href="./lifestaff<?php echo linklang;?>" id='lifes'><?php echo lifes; ?></a>
                        </div>
                    </div>
                </div>
            </li>
