            ...
            <li class="nav-item">
                <div class="dropdown">
                    ...
                    <div class="dropdown-content guide">
                        <div class="xp">
                            <h1><?php echo prog; ?></h1>
                            <a id='chxp'><?php echo chxp; ?></a>
                            <a id='wxp'><?php echo wxp; ?></a>
                            <a id='inv'><?php echo inv; ?></a>
                        </div>
                        <div class="gathering">
                            <h1><?php echo gather; ?></h1>
                            <a id='skin'><?php echo skin; ?></a>
                            <a id='min'><?php echo min; ?></a>
                            <a id='log'><?php echo log; ?></a>
                            <a id='harv'><?php echo harv; ?></a>
                            <a id='fish'><?php echo fish; ?></a>
                        </div>
                        <div class="pvp">
                            <h1><?php echo pvp; ?></h1>
                            <a id='war'><?php echo war; ?></a>
                            <a id='fort'><?php echo fort; ?></a>
                            <a id='city'><?php echo city; ?></a>
                        </div>
                    </div>
                </div>
            </li>
            <li class="nav-item">
                <div class="dropdown">
                    ...
                    <div class="dropdown-content build">
                        <div class="weapons">
                            <a id='ss'><?php echo ss; ?></a>
                            <a id='hatch'><?php echo hatch; ?></a>
                            <a id='rap'><?php echo rap; ?></a>
                            <a id='lan'><?php echo lan; ?></a>
                            <a id='hamm'><?php echo hamm; ?></a>
                            <a id='grtx'><?php echo grtx; ?></a>
                            <a id='bow'><?php echo bow; ?></a>
                            <a id='musk'><?php echo musk; ?></a>
                            <a id='fires'><?php echo fires; ?></a>
                            <a id='iceg'><?php echo iceg; ?></a>
                            <a id='lifes'><?php echo lifes; ?></a>
                        </div>
                    </div>
                </div>
            </li>
