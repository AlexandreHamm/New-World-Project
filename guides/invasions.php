            ...
            <li class="nav-item">
                <div class="dropdown">
                    ...
                    <div class="dropdown-content guide">
                        <div class="xp">
                            <h1><?php echo prog; ?></h1>
                            <a href="./characterXp<?php echo linklang;?>" id='chxp'><?php echo chxp; ?></a>
                            <a href="./weaponXp<?php echo linklang;?>" id='wxp'><?php echo wxp; ?></a>
                            <a href="./invasions<?php echo linklang;?>" id='inv'><?php echo inv; ?></a>
                        </div>
                        <div class="gathering">
                            <h1><?php echo gather; ?></h1>
                            <a href="./skinning<?php echo linklang;?>" id='skin'><?php echo skin; ?></a>
                            <a href="./mining<?php echo linklang;?>" id='min'><?php echo min; ?></a>
                            <a href="./logging<?php echo linklang;?>" id='log'><?php echo log; ?></a>
                            <a href="./harvesting<?php echo linklang;?>" id='harv'><?php echo harv; ?></a>
                            <a href="./fishing<?php echo linklang;?>" id='fish'><?php echo fish; ?></a>
                        </div>
                        <div class="pvp">
                            <h1><?php echo pvp; ?></h1>
                            <a href="./wars<?php echo linklang;?>" id='war'><?php echo war; ?></a>
                            <a href="./fortresses<?php echo linklang;?>" id='fort'><?php echo fort; ?></a>
                            <a href="./cities<?php echo linklang;?>" id='city'><?php echo city; ?></a>
                        </div>
                    </div>
                </div>
            </li>
